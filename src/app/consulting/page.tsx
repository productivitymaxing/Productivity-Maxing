...
export default function ConsultingPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#000b29] bg-[radial-gradient(circle_at_0%_0%,_rgba(0,92,255,0.9)_0%,_transparent_55%),radial-gradient(circle_at_100%_0%,_rgba(0,72,255,0.85)_0%,_transparent_55%),radial-gradient(circle_at_10%_100%,_rgba(0,180,255,0.9)_0%,_transparent_55%),radial-gradient(circle_at_90%_100%,_rgba(0,120,255,0.8)_0%,_transparent_55%),radial-gradient(ellipse_at_center,_#0020b8_0%,_#000b29_70%,_#00040f_100%)] bg-no-repeat text-white flex flex-col justify-center overflow-hidden">
