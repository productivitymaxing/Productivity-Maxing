  ...
  return (
    <main className="pb-20">
      <section className="px-4 pt-16 sm:pt-20">
        <div className="mx-auto grid max-w-7xl gap-6 rounded-3xl border border-slate-200/80 bg-gradient-to-b from-white to-slate-100 p-6 shadow-sm sm:gap-10 sm:p-12 lg:grid-cols-2 dark:border-slate-800 dark:from-slate-900 dark:to-slate-950">
          <div>
          ...
          <div className="grid gap-3 sm:gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-2 sm:mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300">Superior Workflow</p>
              <p className="mt-1 text-lg sm:text-2xl font-semibold">Create Max</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900">
              <BarChart3 className="text-blue-600" size={22} />
              <p className="mt-2 sm:mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300">Brand Voice Synthesis</p>
              <p className="mt-1 text-lg sm:text-2xl font-semibold">Precision</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900">
              <Bot className="text-blue-600" size={22} />
              <p className="mt-2 sm:mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300">Predictive Performance Tracker</p>
              <p className="mt-1 text-lg sm:text-2xl font-semibold">Forecast-ready</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900">
              <ShieldCheck className="text-blue-600" size={22} />
              <p className="mt-2 sm:mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300">Multi-platform Content Ecosystem</p>
              <p className="mt-1 text-lg sm:text-2xl font-semibold">Scale output</p>
            </div>
          </div>
        </div>
      </section>
